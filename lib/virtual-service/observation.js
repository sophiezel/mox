...
/**
 * Build Observation from a doc-extracted endpoint.
 * @param {object} endpoint
 * @returns {object|null}
 */
function observationFromDoc(endpoint) {
  ...
  return {
    ...
    path: urlPath,
    stubId: endpoint.stubId || null,
    query: endpoint.query && typeof endpoint.query === 'object' ? endpoint.query : {},
    requestBody,
    responseBody,
    data,
    status: endpoint.status != null ? Number(endpoint.status) : 200,
