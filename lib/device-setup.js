...
<body>
  ...
  <div class="box warn">
    ...
    <p class="muted" style="margin:8px 0 0">业务页（如 ping-fe）可能透传真实证书，绿盾不代表 MITM CA 生效。请打开任一 catalog HTTPS 接口域名下的 <code>/__mox_mitm_check</code>，应返回 <code>{"ok":true,"fingerprintShort":"${fp || '…'}"}</code>。</p>
  ...
  <div class="box">
    ...
    <ol>
      ...
      <li>先过 <code>/__mox_mitm_check</code>，再打开业务 H5</li>
    </ol>
  </div>
</body>
</html>
